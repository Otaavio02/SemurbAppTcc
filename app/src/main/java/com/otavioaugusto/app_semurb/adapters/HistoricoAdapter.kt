...
class HistoricoAdapter(
    val historicoLista: MutableList<DataClassHistorico1>
    ...
    override fun onBindViewHolder(holder: HistoricoViewHolder, position: Int) {
        val  historico = historicoLista[position]

        holder.titulo.text = historico.tipo
        holder.horario.text = historico.horario.toString()
        holder.tamanho.text = ("${historicoLista.size} ${historico.tipo}")
    }

    override fun getItemCount(): Int = historicoLista.size
}